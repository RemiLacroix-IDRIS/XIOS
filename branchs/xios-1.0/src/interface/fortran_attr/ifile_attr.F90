...
CONTAINS
  ...
  SUBROUTINE xios(set_file_attr)  &
    ( file_id, append, compression_level, description, enabled, min_digits, name, name_suffix, output_freq  &
    ...
    IMPLICIT NONE
      ...
      ( file_hdl, append, compression_level, description, enabled, min_digits, name, name_suffix, output_freq  &
      , output_level, par_access, split_freq, split_freq_format, sync_freq, time_counter, type )
  ...
  SUBROUTINE xios(set_file_attr_hdl_)   &
    ( file_hdl, append_, compression_level_, description_, enabled_, min_digits_, name_, name_suffix_  &
    , output_freq_, output_level_, par_access_, split_freq_, split_freq_format_, sync_freq_, time_counter_  &
    , type_ )
